...
import {
  selBox, inputX, inputY, inputW, inputH,
  previewCanvas, updateLivePreview,
  updateHeaderCoords, onCanvasMouseLeave,
} from './ui.js';
...
cropBtn.addEventListener('click', () => { if (state.selectionActive && state.cropW > 0) updateLivePreview(); });
newCropBtn.addEventListener('click', () => { if (state.img) startCropping(); });
